...
//                .override(100, 100)
        ...
        ((GoodsHomeTypeAdapter.GoodsViewHolder)holder).textView.setText(products.get(position).getRow().getTitle());
        ((GoodsHomeTypeAdapter.GoodsViewHolder)holder).tv_money.setText("¥"+products.get(position).getRow().getCouponAfterPrice());
        ((GoodsHomeTypeAdapter.GoodsViewHolder)holder).tv_count.setText("已售"+products.get(position).getRow().getVolume()+"件");
