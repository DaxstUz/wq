...
public class ConsultMsgFragment extends BaseFragment {
    ...
    public static ConsultMsgFragment newInstance() {
    ...
    private MsgConsultAdapter consultAdapter;
    ...
    private void initRecycle(){
        ...
        consultAdapter=new MsgConsultAdapter(getActivity(),data);
...
//        recyclerView.addItemDecoration(decoration);
        ...
        lRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("infoCode",data.get(position).getExtend().getInfoCode());
