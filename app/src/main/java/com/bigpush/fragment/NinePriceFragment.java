 ...
 * 9块9子页
 */
public class NinePriceFragment extends BaseFragment {
    ...
    public static NinePriceFragment newInstance(String cat) {
        NinePriceFragment fragment = new NinePriceFragment();
