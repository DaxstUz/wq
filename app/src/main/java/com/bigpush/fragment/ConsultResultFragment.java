...
//
//public class ConsultResultFragment extends  BaseFragment {
//
...
//    private List<MsgGoodsResp.DataBean>data=new ArrayList<>();
//
...
//            MsgGoodsResp msgGoodsResp= JSON.parseObject(response.get().toString(),MsgGoodsResp.class);
//            if("1".equals(msgGoodsResp.getStatus())){
//                if(msgGoodsResp!=null&&msgGoodsResp.getData()!=null){
//                    if (0 == page) {
//                        data.clear();
//                    }
